  ...
  const services = [
    {
      ...
      link: '/services/intelligent-marketing/digital-marketing'
    },
    {
      ...
      link: '/services/intelligent-marketing/content-marketing'
    },
    {
      ...
      link: '/services/intelligent-marketing/marketing-automation'
    },
    {
      ...
      link: '/services/intelligent-marketing/social-media'
    },
    {
      title: 'SEO & SEM',
      description: '',
      ...
      link: '/services/intelligent-marketing/seo-sem'
    },
    {
      ...
      link: '/services/intelligent-marketing/marketing-analytics'
    }
  ];
      ...
      <div className="min-h-screen force-gray-bg">
        ...
        <section className="container mx-auto py-16 px-4">
          <div className="max-w-4xl mx-auto mb-12">
            <h2 className="text-3xl font-bold text-red-600 mb-6">Our Intelligent Marketing Services</h2>
          ...
          <div className="max-w-4xl mx-auto mt-16 bg-red-50 rounded-lg p-8 border border-red-100">
            <h3 className="text-2xl font-bold text-red-600 mb-4">Ready to Transform Your Marketing Strategy?</h3>
...
export default IntelligentMarketing; 
